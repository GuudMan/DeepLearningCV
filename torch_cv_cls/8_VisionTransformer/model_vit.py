...
def drop_path(x, drop_prob=0., training=False):
    ...
    This is the same as the DropConnect impl I create for EfficientNet, etc, networks, however,
    this original name is misleading "Drop Connect" is a different form of dropout in a separate paper..
...
class PatchEmbed(nn.Module):
    ...
    def forward(self, x):
        ...
        assert H == self.img_size[0] and W == self.img_size[1], \
            f"Input image size {self.img_size[0]} * {self.img_size[1]} doesn't match model"
...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_c=3, num_classes=1000,
        ...
        :param representation_size: enable and set representation
        :param distilled: model includes a distillation token and head as DeiT models
