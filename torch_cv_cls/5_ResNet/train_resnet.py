...
def main():
    ...
    with open("./4_ResNet/class_indices.json", 'w') as json_file:
    ...
    epochs = EPOCHS
    best_acc = 0.0
    save_path = "./5_ResNet/model/resnet34.pth"
