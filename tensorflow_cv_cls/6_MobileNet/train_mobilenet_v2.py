...
def main():
    ...
    with open("./6_MobileNet/class_indices.json", 'w') as f:
        f.write(json_str)
    ...
    model = MobileNetV2(num_classes=5, include_top=False)
    # 下载链接： https://pan.baidu.com/s/1YgFoIKHqooMrTQg_IqI2hA  密码： 2qht
    pre_weights_path = "./6_MobileNet/model/tf_mobilenet_v2_weights/pretrain_weights.ckpt"
    ...
    for epoch in range(epochs):
        ...
        if val_accuracy.result() > best_acc:
            ...
            model.save_weights("./6_MobileNet/model/mobilenetv2.ckpt", save_format="tf")
